...
class Wav2VecCNNConfig(PretrainedConfig):
    """
    ...
    model_type = "wav2vecCNN_classifier"
...
class Wav2VecCNN(PreTrainedModel):

    config_class = Wav2VecCNNConfig

    def __init__(self, config: PretrainedConfig, **kwargs): 
        super(Wav2VecCNN, self).__init__(config)
